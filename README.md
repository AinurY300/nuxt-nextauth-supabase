# Nuxt с Supabase и NextAuth
---

Веб-приложение с использованием Nuxt.js и установленным плагином NextAuth который обеспечивает аутентификацию и авторизацию. Для хранения данных о пользователях и сессиях я решил использовать Supabase.
### # Установка
```sh
yarn install
yarn dev
...
### # Настройка Supabase
Чтобы настроить взаимодействие плагина NextAuth с Supabase, вам потребуется выполнить несколько запросов в SQL-Editor
...
| ------ | ------ |
| Auth.js | [https://authjs.dev/reference/adapter/supabase] |
